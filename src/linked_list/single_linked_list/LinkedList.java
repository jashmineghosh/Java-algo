...
public class LinkedList {
    ...
    public LinkedList reverse1(LinkedList linkedList) {
    ...
    public LinkedList reverse(LinkedList linkedList){
        LinkedList linkedList1 = new LinkedList(linkedList.head.value);
        Node current= linkedList.head;
        while(current.next!=null){
            Node newCurrent= new Node(current.next.value);
            newCurrent.next =  linkedList1.head;
            linkedList1.head = newCurrent;
            linkedList1.length++;
            current=current.next;
        }
        return linkedList1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("list: " + Arrays.toString(myLinkedList.printList()));
        //reverse
        LinkedList linkedList2 = myLinkedList.reverse1(myLinkedList);
        LinkedList linkedListMy = myLinkedList.reverse(myLinkedList);
        System.out.println("reverse linkedList" + Arrays.toString(linkedList2.printList()));
        System.out.println("reverse linkedList" + Arrays.toString(linkedListMy.printList()));
    }
}
